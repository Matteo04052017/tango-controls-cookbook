...
BEGIN
    ...
    IF ret_id = 0 THEN
        INSERT INTO tango.access_address VALUES ('*','*.*.*.*','FF.FF.FF.FF',20060824131221,00000000000000);
    END IF;
    ...
    IF ret_id = 0 THEN
        INSERT INTO tango.access_device VALUES ('*','*/*/*','write',20060824131221,00000000000000);
    END IF;
END |
